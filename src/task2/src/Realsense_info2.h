...
class RealsenseInfo2
{
public:
    RealsenseInfo2(ros::NodeHandle nh);
    ~RealsenseInfo2();
    ...
    void wristcattleCallback(const task2::MyListArrayConstPtr &wrist_cattle_msg);
    void wristbottomCallback(const task2::MyListArrayConstPtr &wrist_bottom_msg);
    void wristboxCallback(const task2::MyListArrayConstPtr &wrist_box_msg);
...
private:
    ...
    ros::Subscriber block_info_sub,box_info_sub,lefthand_camera_info_sub,righthand_camera_info_sub,
                    ...
                    wrist_cattle_sub,wrist_bottom_sub,wrist_box_sub;
