...
//    void jntCmdPub(std::vector<double> tarJnt, const std::string &armID);
  ...
  TRAC_IK::SolveType Type=TRAC_IK::Distance,std::vector<double> lower={-1.7016, -2.147, -3.0541, -0.05, -3.059, -1.5707, -3.059}
  ,std::vector<double> upper={ 1.7016,  1.2471,  3.0541,  2.618, 3.059,  2.094,   3.059});
