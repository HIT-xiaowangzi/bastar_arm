...
bool PointTransform(task1::GetPoint::Request &req,task1::GetPoint::Response &res)
{
    ...
    else
    {
        ...
        for(int i=0;i<size;i++)
        {
            ...
            // tempPose[i].position.x=ans.position.x;
            // tempPose[i].position.y=ans.position.y;
            // tempPose[i].position.z=ans.position.z;
            // tempPose[i].orientation.w=ans.orientation.w;
            // tempPose[i].orientation.x=ans.orientation.x;
            // tempPose[i].orientation.y=ans.orientation.y;
            // tempPose[i].orientation.z=ans.orientation.z;
